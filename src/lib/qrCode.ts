...
export function generateQrSvgString({
  ...
  if (showIcon) {
    ...
    if (iconType === "linkedin") {
      ...
      // Distinct QR scan glyph
      elements += `<g transform="translate(${iconX}, ${iconY}) scale(0.14)" fill="${color}">
        <path d="M3 3h6v6H3V3zm2 2v2h2V5H5zm8-2h6v6h-6V3zm2 2v2h2V5h-2zM3 13h6v6H3v-6zm2 2v2h2v-2H5zm13-2h3v3h-3v-3zm-5 0h3v1h-3v-1zm2 2h3v3h-3v-3zm3 2h2v2h-2v-2zm-5 1h2v2h-2v-2z"/>
      </g>`;
    } else {
      // Globe
